        ...
        screen("ATMOSPHERE", 2) {
            ...
            screen("CLOUDS", 2) {
                ...
                screen("CLOUDS_LIGHTING", 1) {
                    ...
                    slider("SETTING_CLOUDS_MS_FALLOFF_AMB", 0.7, 0.0..1.0 step 0.05) {
                        lang {
                            name = "Multi-Scattering Ambient Irradiance Falloff"
                        }
                    }
                    empty()
                    slider("SETTING_CLOUDS_AMB_UNI_PHASE_RATIO", 0.4, 0.0..1.0 step 0.05) {
                        lang {
                ...
                screen("HIGH_CLOUDS", 1) {
                    ...
                    slider("SETTING_CLOUDS_CI_HEIGHT", 9.0, 0.0..20.0 step 0.1) {
                        lang {
                            name = "Cirrus Height"
                            suffix = " km"
                        }
