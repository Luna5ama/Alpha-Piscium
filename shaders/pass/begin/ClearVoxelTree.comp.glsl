...
// Each 8x8x1 workgroup clears a 8x8 slice of one Z layer.
// Each invocation clears exactly one texel.
//
// Grid=16: ivec3( 8,  8,  85) workgroups ->  64x 64x 85 texels
// Grid=32: ivec3(16, 16, 171) workgroups -> 128x128x171 texels
// Grid=64: ivec3(32, 32, 341) workgroups -> 256x256x341 texels
...
const ivec3 workGroups = ivec3(32, 32, 341);
#elif VOXEL_GRID_SIZE == 32
const ivec3 workGroups = ivec3(16, 16, 171);
#else // VOXEL_GRID_SIZE == 16
const ivec3 workGroups = ivec3(8, 8, 85);
#endif
