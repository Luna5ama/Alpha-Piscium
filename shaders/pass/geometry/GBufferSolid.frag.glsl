...
void processAlbedo() {
    ...
    float alphaTestBias = 1.0 - pow2(global_taaResetFactor.y) * 0.9;
    ...
    alphaTestThreshold += min(pow(rand_stbnVec1(texelPos, frameCounter), alphaLod + 1.0), 0.9) * saturate(alphaLod);
    #endif
