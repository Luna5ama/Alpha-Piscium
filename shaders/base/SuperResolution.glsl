...
#if SUPER_RESOLUTION_ACTIVE && SR_SHOULD_APPLY_SCALE
#define EXTERNAL_SR_UPSCALING_ACTIVE 1
#else
#define EXTERNAL_SR_UPSCALING_ACTIVE 0
#endif

#if INTERNAL_FSR3_ACTIVE || EXTERNAL_SR_UPSCALING_ACTIVE
