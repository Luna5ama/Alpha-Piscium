...
#define _RGBA8_1_OFFSET ivec2(uval_mainImageSizeI.x * 0, uval_mainImageSizeI.y * 1)
#define _RGBA8_1_OFFSET_F vec2(uval_mainImageSizeI.x * 0, uval_mainImageSize.y * 1)
#define _RGBA8_1_SIZE uval_mainImageSizeI
#define _RGBA8_1_SIZE_F uval_mainImageSize
#define _RGBA8_1_SIZE_RCP uval_mainImageSizeRcp
#define _RGBA8_1_TEXEL_TO_TEXEL(texelPos) _textile_texelToTexel(texelPos, _RGBA8_1_OFFSET, _RGBA8_1_SIZE)
#define _RGBA8_1_UV_TO_UV(uv) _textile_uvToUV(uv, _RGBA8_1_OFFSET_F, _RGBA8_1_SIZE_F, _RGBA8_1_SIZE_RCP)
#define _RGBA8_1_UV_TO_GATHER_UV(uv) _textile_uvToGatherUV(uv, _RGBA8_1_OFFSET_F, _RGBA8_1_SIZE_F, _RGBA8_1_SIZE_RCP)
#define transient_edgeMaskTemp_sample(x) texture(usam_rgba8, _RGBA8_0_UV_TO_UV(x))
#define transient_edgeMaskTemp_gather(x, c) textureGather(usam_rgba8, _RGBA8_0_UV_TO_GATHER_UV(x), c)
#define transient_edgeMaskTemp_fetch(x) texelFetch(usam_rgba8, _RGBA8_0_TEXEL_TO_TEXEL(x), 0)
#define transient_edgeMaskTemp_load(x) imageLoad(uimg_rgba8, _RGBA8_0_TEXEL_TO_TEXEL(x))
#define transient_edgeMaskTemp_store(x, v) imageStore(uimg_rgba8, _RGBA8_0_TEXEL_TO_TEXEL(x), v)
#define transient_edgeMask_sample(x) texture(usam_rgba8, _RGBA8_1_UV_TO_UV(x))
#define transient_edgeMask_gather(x, c) textureGather(usam_rgba8, _RGBA8_1_UV_TO_GATHER_UV(x), c)
#define transient_edgeMask_fetch(x) texelFetch(usam_rgba8, _RGBA8_1_TEXEL_TO_TEXEL(x), 0)
#define transient_edgeMask_load(x) imageLoad(uimg_rgba8, _RGBA8_1_TEXEL_TO_TEXEL(x))
#define transient_edgeMask_store(x, v) imageStore(uimg_rgba8, _RGBA8_1_TEXEL_TO_TEXEL(x), v)
