...
| [`RenderVolumetric`](../../../shaders/techniques/atmospherics/clouds/RenderVolumetric.comp.glsl), `clouds/ss/Accum`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Optional cumulus render → temporal/spatial accumulation                                                                   |
...
1. Optional initial ray sort/finish for long initial SST paths (`SETTING_GI_INITIAL_SST_STEPS >= 64`).
2. Temporal reuse and optional duplication-map decorrelation.
3. Up to four indirect paired spatial-reuse batches gated at reuse counts `> 0/7/14/21`, dispatched from SSBO 0 offset
   48.
4. Paired shade, spatial ray sort, and trace.
5. Denoiser accumulation, optional anti-firefly, GI mip, history fix, and optional blur/post-blur.
6. Optional SST-step debug.
