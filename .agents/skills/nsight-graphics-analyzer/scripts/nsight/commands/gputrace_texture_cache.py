"""`gputrace-texture-cache` — L1TEX hit rate & cache efficiency diagnosis."""
...
from nsight.queries import texture_cache as texture_cache_query
...
def run(args: argparse.Namespace) -> int:
    ...
    result = texture_cache_query.query(trace, in_marker_re=in_marker_re)
